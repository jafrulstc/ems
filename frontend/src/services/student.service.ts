...
export const StudentService = {
  // Guardians
  getGuardians: (params?: any) => api.get('/student/guardians', { params }).then(r => r.data),
  ...
  // Students
  getStudents: (params?: any) => api.get('/student/students', { params }).then(r => r.data),
  ...
  // Enrollments
  getEnrollments: (params?: any) => api.get('/student/enrollments', { params }).then(r => r.data),
